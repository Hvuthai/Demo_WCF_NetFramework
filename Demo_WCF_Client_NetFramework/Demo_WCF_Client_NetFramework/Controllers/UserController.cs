using Demo_WCF_Client_NetFramework.Models;
...
namespace Demo_WCF_Client_NetFramework.Controllers
{
    public class UserController : Controller
    {
        private readonly HttpClient Client = new HttpClient();
        private string CustomerApiUrl = "http://localhost/Demo_WCF_NetFramework/Demo_WCF_NetFramework.UserService.svc/User";
